...
int main()
{
	...
	pOut->PrintMessage("Drawing a Hexagon ==> non-filled,  Click center point");
	pIn->GetPointClicked(P1.x, P1.y);
	...
	pOut->PrintMessage("Drawing a Circle ==> non-filled, Click for center, then for point to be Radius");
	...
	pOut->DrawCircle(center, radius, gfxInfo, false);

	pOut->PrintMessage("Drawing a Circle ==> Highlighted non-filled, Click to Highlight");
	pIn->GetPointClicked(x, y);	//Wait for any click
	pOut->DrawCircle(center, radius, gfxInfo, true);

	pOut->PrintMessage("Drawing a Circle ==> filled, Click for center, then for point to be Radius");
	pIn->GetPointClicked(center.x, center.y);
	pIn->GetPointClicked(radius.x, radius.y);
	...
	do
	{
        ...
        case DRAW_HEX: 
			pOut->PrintMessage("Action: Draw a Heaxagon , Click anywhere");
			break;
        case DRAW_TRIANGLE:
        ...
        case PICK_ORANGE:
			pOut->PrintMessage("Action: Orangle color , Click anywhere");
			break;
        ...
        case FILL_SHAPE:
			pOut->PrintMessage("Action: Fill shape, Click anywhere");
			break;

        case COLOR_BORDER:
			pOut->PrintMessage("Action: Change outline color, Click anywhere");
			break;
        ...
        case SENDTOBACK:
			pOut->PrintMessage("Action: Send Shape to back, Click anywhere");
			break;
		...
		case PICKTYPE:
			pOut->PrintMessage("Action: Pick shapes by type, Click anywhere");
			break;

		case PICKCOLOR:
			pOut->PrintMessage("Action: Pick shapes by color, Click anywhere");
			break;
